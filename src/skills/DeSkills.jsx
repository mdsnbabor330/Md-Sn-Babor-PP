...
const skills = [
  ...
  { name: "Illustrator", percentage: 85, icon: TbBrandAdobeIllustrator },
  { name: "Photoshop",   percentage: 70, icon: TbBrandAdobePhotoshop },
  { name: "Adobe XD",    percentage: 75, icon: TbBrandAdobeXd },
...
const DeSkills = () => {
  ...
  return (
    <div className="w-full overflow-hidden py-4 relative" role="list" aria-label="Design skills">
      <motion.div
