    ...
    <>
      ...
      <div className='min-h-screen w-full flex items-center justify-center bg-transparent p-0 sm:p-4'>
        <motion.div 
          ...
          className='w-full max-w-7xl bg-[#222222] border border-gray-50/20 flex flex-col lg:flex-row relative shadow-2xl shadow-black/50 lg:shadow-[0_0_40px_rgba(120,204,109,0.15)] lg:rounded-xl lg:h-[85vh] 2xl:h-[70vh] lg:border-2 overflow-hidden'
        >
          <Navbar />
